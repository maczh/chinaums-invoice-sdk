...
type GenerateQRCodeRequest struct {
    ...
    NotifyUrl         string `json:"notifyUrl"`         // 商户通知地址(1-256字符)
    ReceiveMobileNo   string `json:"receiveMobileNo"`   // 消费者接收二维码手机号(1-16字符)
    ReceiveEmail      string `json:"receiveEmail"`      // 消费者接收二维码邮箱(1-64字符)
